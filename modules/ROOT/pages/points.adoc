...
#
# Added .shape: rectangle to 'activate' classes after overwriting it with MarkDown
#
1_1.class: hidden
1_2.class: hidden
1_3.class: hidden
...
AP: "esmp:AccountingPoint" {class: esmp}
BP: |md [eu:BoundaryPoint](https://netbeheer-nederland.github.io/im-cgmes/Core%20Equipment/BoundaryPoint/) | {class: eu}
CEq: |md [ConductingEquipment](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/ConductingEquipment.html) | {class: default}
CN: |md [ConnectivityNode](https://netbeheer-nederland.github.io/docs/im-tc57cim/v1.0.0/schema/class/ConnectivityNode.html) | {class: default}
CP: "esmp:ConnectionPoint" {class: esmp}
EC: |md [EnergyConsumer](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/EnergyConsumer.html) | {class: default}
ED: |md [EndDevice](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/EndDevice.html) | {class: default}
EP: "esmp:ExchangePoint" {class: esmp}
Eq: |md [Equipment](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/Equipment.html) | {class: default}
MEP: |md [cim:MarketEvaluationPoint](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/MarketEvaluationPoint.html) | {class: cim}
MR: |md [MeterReading](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/MeterReading.html) | {class: default}
Mmt: |md [Measurement](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/Measurement.html) | {class: default}
Mtr: |md [Meter](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/Meter.html) | {class: default}
PSR: |md [PowerSystemResource](https://netbeheer-nederland.github.io/docs/im-tc57cim/v1.0.0/schema/class/PowerSystemResource.html) | {class: default}
T: |md [Terminal](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/Terminal.html) | {class: default}
UP: |md [cim:UsagePoint](https://netbeheer-nederland.github.io/docs/im-tc57cim/latest/schema/class/UsagePoint.html) | {class: cim}
...
| UsagePoint __[Meetpunt]__ | Physical connection and metering | Identifies the physical location where energy is delivered to or consumed by a customer and the associated metering equipment.
...
_based on: cim:IdentifiedObject_
====
...
= Exchange point
====
_esmp:ExchangePoint, edsn:overdrachtspunt, nbnl:netkoppeling_
